...
<div class="page-content">
    <div class="page-header">
        <h2><i class="bi bi-pencil-square"></i> Edit Survei</h2>
        <p>Perbarui data survei WebQual yang sudah dibuat sebelumnya</p>
    </div>
        ...
        <div class="card-body">
            <form method="POST" action="/sertifikasi-latihan3/survei/update">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="judul_survei" class="form-control"
                        value="<?= htmlspecialchars($survei['judul_survei']); ?>" required>
                </div>
